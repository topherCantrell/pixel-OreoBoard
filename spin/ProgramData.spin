...
'INIT_handler
  ...
  byte $09,$00,$01,$00,$00,$00,$00,$00,$0A,$00,$00 '   defineColor(color=1,W=0, R=0,   G=10, B=0)
  byte $09,$00,$02,$00,$00,$00,$00,$00,$0A,$00,$0A '   defineColor(color=2,W=0, R=0,   G=10, B=10)
  byte $0B,$00,$03,$03,$01,$00,$01,$00,$01,$00,$00,$01,$00 '   pattern(number=0) {
  '	  1.1
  '	  .1.
  '	  .1.
  '  }
  byte $0C,$00,$00,$00,$06,$00,$03,$00,$00 '   drawPattern(number=0,x=6,y=3,colorOffset=0)
  byte $01,$13,$88 '   pause(time=5000)
  byte $04,$00,$00,$00 '   [x] = 0
  'HERE:
  byte $07,$00,$17 '   gosub(doit)
